...
/** A menu row. */
export const MENU_ITEM = 'flex w-full items-center gap-2 rounded-md px-2.5 py-2 text-sm cursor-pointer hover:bg-accent';
/** A destructive menu row (Delete). */
export const MENU_ITEM_DANGER =
  'flex w-full items-center gap-2 rounded-md px-2.5 py-2 text-sm cursor-pointer text-destructive hover:bg-destructive/10';
